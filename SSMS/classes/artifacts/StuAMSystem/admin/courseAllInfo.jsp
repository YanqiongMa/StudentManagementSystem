    ...
    <div class="div_list panel panel-default">
		...
		<table class="table panel-body" id="tableClass">
			...
			<tr>
				...
				<td><a href="ServletSelectCos?courseID=${list.getCourseID() }">Edit</a>&nbsp;&nbsp;&nbsp;<a href="ServletDeleteCos?courseID=${list.getCourseID() }" onclick="return confirm('Do you want to delete?')">Delete</a></td>
