    ...
    <div class="div_list panel panel-default">
		...
		<table class="table panel-body" id="tableClass">
			...
			<tr>
				...
				<td><a href="ServletSelectTea?teanum=${list.getTeaNum() }">Edit</a>&nbsp;&nbsp;&nbsp;<a href="ServletDeleteTea?teanum=${list.getTeaNum() }" onclick="return confirm('Do you want to delete ?')">Delete</a></td>
