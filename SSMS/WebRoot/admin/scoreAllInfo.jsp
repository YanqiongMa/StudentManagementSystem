...
function page(s){
  ...
  <form action="ServletSearchScore" method="post" id="frm">
    <div class="div_list">
    Course：<input type="text" class="form-control form1"   name="cosName" value="${score.getCourseName() }" />&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<table class="table panel-body" id="tableClass">
			...
			<tr>
					<td colspan="7">
						...
						<input
						type="submit" class="btn btn-primary" value="redirect to" /> We have${list.totalPage }pages</td>
				</tr>
		</table>
	</div>
	</div>
